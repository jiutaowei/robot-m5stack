...
void Hal::startSntp()
{
    ...
    if (esp_sntp_enabled()) {
        ...
        // sdkconfig permits one SNTP server.  Use the China National Time
        // Service Center directly instead of configuring unused fallback
        // entries, then render it in the Shanghai timezone (CST-8).
